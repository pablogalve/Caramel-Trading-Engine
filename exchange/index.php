...
<div class="w3-container" style="padding:128px 16px;background-color:black" id="home">
  <div class="w3-center">
    <h1 style="color:#D9D9D9;font-family:Roboto;">CARAMEL CAPITAL</h1>
    ...
    <br>
    <br>
    <button class="w3-button w3-xlarge w3-round-xxlarge" style="background:#D9AA52;color:#D9D9D9">GET STARTED</button>
  </div>
</div>
